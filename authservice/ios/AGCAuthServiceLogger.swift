...
let AGCAuthServiceLog = AGCAuthServiceLogger(version: "1.9.0.300", service: "ReactNativeAuthService")

/// Custom AGCAuthServiceLogger Class to listen api log events from RN Side.
final class AGCAuthServiceLogger {
  ...
  private var prefix: String = GenericFunctions.className(AGCAuthServiceLogger.self)
  ...
  func showInPanel(callTime: Double? = nil,
                   ...
                   type: AGCAuthServiceLogger.InfoType) {
    switch type {
    case .call:
      printCall(name)
      return
