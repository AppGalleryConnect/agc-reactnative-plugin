...
let AGCCloudDBLog = AGCCloudDBLogger(version: "1.9.0.300", service: "ReactNativeCloudDB")

/// Custom AGCCloudDBLogger Class to listen api log events from RN Side.
final class AGCCloudDBLogger {
  ...
  private var prefix: String = GenericFunctions.className(AGCCloudDBLogger.self)
  ...
  func showInPanel(callTime: Double? = nil,
                   ...
                   type: AGCCloudDBLogger.InfoType) {
    switch type {
    case .call:
      printCall(name)
      return
