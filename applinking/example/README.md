# React-Native AGC Applinking - Demo
...
This demo project is an example to demonstrate the features of the **AGC React-Native Applinking Kit** Plugin.
...
AGC React-Native Applinking - Demo is licensed under [Apache 2.0 license](LICENCE)
