...
import AGCRemoteConfig, { SOURCE} from '@hw-agconnect/react-native-remoteconfig';
...
const App =() => {
    return (
        <View style={Styles.sectionContainer}>
            ...
            <Button
                title="setCustomAttributes"
                onPress={() => {
                    var map = new Map();
                    map.set("default_key_string", '11');
                    map.set("default_key_true", true);
                    map.set("default_key_int", 1000);
                    map.set("default_key_double", 5.14);
                    AGCRemoteConfig.setCustomAttributes(map);
                }}
            />
            <Separator />
              ...
              <Button
                 ...
                 onPress={() => {
                    AGCRemoteConfig.getCustomAttributes().then((map) => {
